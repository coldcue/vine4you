...
(function () {
    ...
    u.k = function (a, c) {
        ...
        c = u.hc(c);
        d.T && d.T.call(a, c);
        if (e && !c.Cb())u.k(e, c); else if (!e && !c.Ab() && (d = u.getData(c.target), c.target[c.type])) {
            d.disabled = f;
    ...
    t.pb = function () {
        var a = u.Ob.wa;
        this.I = l;
        if (a)document[a.ob](); else this.h.Sa() ? K(this, "exitFullScreen") : (L(this), this.k("fullscreenchange"));
        return this
    };
    t.ic = function (a) {
    ...
    t.e = function () {
        var a = this.a, c = a.F;
        if (!c || this.j.Uc === l)c ? (c.player = h, a.F = h, a.r().removeChild(c), c = c.cloneNode(l)) : c = u.e("video", {id: a.id() + "_html5_api", className: "vjs-tech"}), c.player = a, u.zb(c, a.r());
    ...
    t.update = function () {
        if (0 < this.ha.length) {
            ...
            if (this.Lb === b || a < this.Lb || this.La <= a) {
                ...
                for (; ;) {
                    n = c[s];
                    if (n.sa <= a)e = Math.max(e, n.sa), n.Ga && (n.Ga = l); else if (a < n.startTime) {
    ...
    u.W.prototype.sb = function () {
        ...
        for (var d = 0; d < U(this.a).length; d++)c = U(this.a)[d], c.K() === this.A && a.push(new u.X(this.a, {track: c}));
        return a
    };
    ...
    t.sb = function () {
        for (var a = [], c, d = 0; d < U(this.a).length; d++)c = U(this.a)[d], c.K() === this.A && a.push(new u.X(this.a, {track: c}));
        return a
    };
    t.Ja = function () {
        ...
        if (g) {
            e = g.ha;
            for (var k, c = 0, d = e.length; c < d; c++)k = e[c], k = new u.Xa(this.a, {track: g, cue: k}), j.push(k), a.Y(k)
        }
